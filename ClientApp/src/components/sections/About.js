...
export function About({ nextSectionName }) {
    const info = {
        ...
        paragraphs: ["Apart from studying and programing, I am definitely a sport loving person. My main passion is powerlifting, which started in 2015 as a casual gym visit, and developed into national level competitive journey.",
